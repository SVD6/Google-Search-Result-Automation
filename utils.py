...
def _get_search_url(query, page=0, per_page=10, lang='en', area='com', ncr=False, time_period=False, sort_by_date=False, filter=0):
...
def get_html(url):
    ...
    try:
        # r = requests.get(url, headers=header, verify=True, timeout=5.0)
